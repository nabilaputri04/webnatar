...
if (isset($_POST['simpan'])) {
    ...
    $query = "UPDATE kontak SET alamat='$alamat', telepon='$telepon', email='$email', facebook='$fb', instagram='$ig', tiktok='$tiktok' WHERE id=1";
    ...
    <main class="main-content w-100">
        ...
        <form action="" method="POST" class="card border-0 shadow-sm rounded-4 p-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold small"><i class="bi bi-tiktok me-1"></i> TIKTOK URL</label>
                    <input type="text" name="tiktok" class="form-control" value="<?php echo htmlspecialchars($data['tiktok'] ?? ''); ?>">
                </div>
            </div>
