            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-green-500">
                ...
                <div class="flex justify-between items-end">
                    <div>
                        ...
                        <div class="text-2xl font-bold text-gray-800">Rp <?= number_format($total['real_pendapatan'] ?? 0, 0, ',', '.'); ?></div>
                    </div>
                    <div class="text-right">
                        <span class="text-xs text-gray-400">Target</span>
                        <div class="text-sm font-semibold text-gray-600">Rp <?= number_format($total['target_pendapatan'] ?? 0, 0, ',', '.'); ?></div>
                    </div>
                </div>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-orange-500">
                ...
                <div class="flex justify-between items-end">
                    <div>
                        ...
                        <div class="text-2xl font-bold text-gray-800">Rp <?= number_format($total['real_belanja'] ?? 0, 0, ',', '.'); ?></div>
                    </div>
                    <div class="text-right">
                        <span class="text-xs text-gray-400">Anggaran</span>
                        <div class="text-sm font-semibold text-gray-600">Rp <?= number_format($total['target_belanja'] ?? 0, 0, ',', '.'); ?></div>
                    </div>
                </div>
            </div>
        </div>
