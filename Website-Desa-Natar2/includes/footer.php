    ...
    <footer class="bg-gray-900 text-gray-300 mt-auto border-t border-gray-800">
        <div class="container mx-auto px-4 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="flex gap-3">
                        <?php if(!empty($contact['facebook'])): ?><a href="<?= $contact['facebook'] ?>" class="w-9 h-9 rounded-full bg-gray-800 flex items-center justify-center hover:bg-emerald-600 hover:text-white transition"><i class="bi bi-facebook"></i></a><?php endif; ?>
            ...
            <div class="border-t border-gray-800 mt-12 pt-8 text-center text-sm text-gray-500">
                &copy; <?= date('Y'); ?> Pemerintah Desa Natar. KKN Tematik Universitas Lampung.
            </div>
        </div>
    </footer>
</body>
