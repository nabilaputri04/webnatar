...
<div class="bg-gray-50 py-12">
    <div class="container mx-auto px-4 max-w-5xl">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-500 max-w-2xl mx-auto">Panduan pengurusan surat dan dokumen kependudukan di Kantor Desa Natar 2.</p>
        </div>
                ...
                <details class="group">
                    <summary class="flex justify-between items-center p-6 cursor-pointer list-none hover:bg-gray-50 transition">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-800 group-hover:text-blue-600 transition"><?= htmlspecialchars($row['nama_layanan']); ?></h3>
                    ...
                    <div class="px-6 pb-6 pt-2 border-t border-gray-50">
                        <div class="grid md:grid-cols-2 gap-8 mt-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-800 mb-3 flex items-center gap-2"><i class="bi bi-list-ol text-blue-500"></i> Prosedur</h4>
