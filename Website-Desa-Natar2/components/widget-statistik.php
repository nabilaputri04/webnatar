 ...
 * Variable required: $profil (array data profil desa)
 */
?>
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 text-center hover:-translate-y-1 transition duration-300">
        ...
        <h3 class="text-3xl font-bold text-gray-800 mb-1"><?= number_format($profil['populasi'] ?? 0); ?></h3>
    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 text-center hover:-translate-y-1 transition duration-300">
        ...
        <h3 class="text-3xl font-bold text-gray-800 mb-1"><?= htmlspecialchars($profil['luas_wilayah'] ?? '0'); ?></h3>
