...
<div class="bg-gray-50 py-12">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-500 max-w-2xl mx-auto">Jelajahi kekayaan alam, UMKM, dan destinasi menarik di Desa Natar 2.</p>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition duration-300 group">
                <div class="relative h-64 overflow-hidden">
                    ...
                    <div class="absolute bottom-4 left-4 text-white">
                        <span class="bg-blue-600 text-xs font-bold px-2 py-1 rounded mb-2 inline-block"><?= $row['nama_kategori']; ?></span>
                ...
                <div class="p-6">
                    ...
                    <a href="<?= $row['lokasi_maps']; ?>" target="_blank" class="w-full block text-center bg-gray-50 hover:bg-blue-50 text-gray-700 hover:text-blue-600 font-semibold py-3 rounded-xl border border-gray-200 transition flex items-center justify-center gap-2">
